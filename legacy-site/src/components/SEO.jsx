...
const SEO = props => {
  ...
  let postURL;
  if (caseSEO === 'post') {
    const caseMeta = caseNode;
    title = config.siteTitleAlt + " | " + caseMeta.title;
    // description = caseMeta.subtitle.text;
    image = caseMeta.acf.preview_image.localFile.childImageSharp.src;
    postURL = config.siteUrl + config.pathPrefix + casePath;
  } else if (caseSEO === 'page') {
    const caseMeta = caseNode;
    title = config.siteTitleAlt + " | " + caseMeta.title;
    // description = caseMeta.subtitle.text;
    image = caseMeta.acf.featured_image.localFile.childImageSharp.src;
    postURL = config.siteUrl + config.pathPrefix + casePath;
  } else {
