...
const BlogHeader = ({
  ...
  const image = (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_2__.getImage)(post.node.frontmatter.featuredimage);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: "max-w-7xl xxs:mx-4 sm:mx-auto mt-10"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_awesome_reveal__WEBPACK_IMPORTED_MODULE_3__.Fade, {
    duration: 2200
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: "flex flex-row justify-space xxs:flex-col-reverse xs:flex-col-reverse sm:flex-row mb-5"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: "max-h-80 w-11/12 xxs:ml-0 xxs:mr-0 sm:ml-5 sm:mr-5 xxs:mt-5 xxs:mb-5 flex flex-col justify-center bg-gradient-to-r from-pink to-purple p-8 rounded-xl lg:m-5 xxs:w-full xs:w-full sm:w-full lg:w-full"
    ...
    className: "text-white text-2xl font-simibold"
  }, post.node.frontmatter.title)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", {
    className: "text-lg mt-4 text-white opacity-70 xxs:text-sm sm:text-lg"
  }, post.node.frontmatter.description)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    "data-gatsby-image-wrapper": "",
    class: "my-5 mr-5 xxs:w-full xs:w-full sm:w-full lg:w-full"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: "overflow-hidden  rounded-xl xxs:w-full"
  }, post.node.frontmatter.featuredimage && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_0__.Link, {
    to: post.node.fields.slug,
    style: {
      textDecoration: "none",
      color: "black"
    ...
    className: "max-h-80 w-auto h-full object-cover flex justify-center"
...
/* harmony import */ var _Atoms_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Atoms/button */ "./src/components/Atoms/button.js");
...
const BlogsContainer = ({
  ...
  let posts = data === null || data === void 0 ? void 0 : data.map(item => {
    return {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "max-w-7xl mx-auto mt-10 px-8 text-black"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_awesome_reveal__WEBPACK_IMPORTED_MODULE_4__.Fade, {
    bottom: true,
    cascade: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "grid grid-cols-3 gap-4 xxs:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"
  }, posts.map((blog, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    key: i
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "overflow-hidden  rounded-xl xxs:w-full "
    ...
    image: (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__.getImage)(blog.featuredimage),
    alt: blog.title,
    placeholder: "none",
    layout: "cover",
    formats: ["auto", "webp", "avif"],
    ...
    className: "text-2xl font-simibold mt-2 mb-4"
  }, blog.title)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-sm opacity-50 mt-2"
  }, blog.description)))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "w-auto p-8 m-4 h-72 sm:h-96 xs:h-96 xxs:h-96 mt-10 bg-gradient-to-r from-pink to-purple rounded-xl flex flex-col items-center justify-center"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: " text-3xl font-bold text-black text-center"
  }, "STAY AHEAD OF THE CURVE"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", {
    className: "text-lg mt-2 opacity-60 text-black text-center"
  }, "Subscribe to our newsletter, we will only send the good stuff!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "text-black hover:text-white mt-10 flex flex-col items-center justify-center"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Atoms_input__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlogsContainer);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_Blog_blogHeader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/Blog/blogHeader */ "./src/components/Blog/blogHeader.js");
/* harmony import */ var _components_Blog_blogsContainer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/Blog/blogsContainer */ "./src/components/Blog/blogsContainer.js");
...
const Blog = ({
  ...
  var _data$allMarkdownRema, _data$allMarkdownRema2;
  console.log("data", data);
  let HeaderPost = data === null || data === void 0 ? void 0 : (_data$allMarkdownRema = data.allMarkdownRemark) === null || _data$allMarkdownRema === void 0 ? void 0 : _data$allMarkdownRema.edges[0];
  let otherPosts = data === null || data === void 0 ? void 0 : (_data$allMarkdownRema2 = data.allMarkdownRemark) === null || _data$allMarkdownRema2 === void 0 ? void 0 : _data$allMarkdownRema2.edges.slice(1);
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Blog_blogHeader__WEBPACK_IMPORTED_MODULE_1__["default"], {
    post: HeaderPost
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Blog_blogsContainer__WEBPACK_IMPORTED_MODULE_2__["default"], {
    data: otherPosts
  }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Blog);
const WorkPageQuery = "2441537616";
